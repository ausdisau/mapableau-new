...
if (!PAYPAL_CLIENT_ID) {
  console.warn("Warning: PAYPAL_CLIENT_ID not set. PayPal payment features will be unavailable.");
}
if (!PAYPAL_CLIENT_SECRET) {
  console.warn("Warning: PAYPAL_CLIENT_SECRET not set. PayPal payment features will be unavailable.");
}
