...
const OPS_LINKS = [
  ...
  { href: "/admin/ai/agent-studio", label: "Agent studio" },
...
const LEGACY_LINKS = [
  ...
  { href: "/admin/platform-registration", label: "Platform registration" },
  { href: "/admin/thin-market", label: "Thin-market" },
  { href: "/admin/safety-gate", label: "AI safety gate" },
