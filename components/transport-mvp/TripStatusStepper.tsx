...
import {
  MVP_STATUS_STEPPER,
  plainLanguageMvpStatus,
} from "@/lib/transport-mvp/trip-lifecycle-service";
...
export function TripStatusStepper({
  ...
  if (isTerminal) {
    return (
      <p
        className="rounded-lg border border-amber-600/40 bg-amber-50 p-3 text-sm dark:bg-amber-950/30"
        role="status"
      >
