...
/** Legacy single-page review form when accessibility_reviews_v1 is off. */
export function AddAccessReviewFormLegacy({ placeId }: { placeId: string }) {
  ...
  return (
    <form className="space-y-6" onSubmit={onSubmit}>
      ...
      <label className="block">
        <span className="font-medium">Mobility context (optional)</span>
        <input
