...
export function NewTransportForm({ dynamicRoutingEnabled }: Props) {
      ...
      onSubmit={async (e) => {
        ...
        const res = await fetch("/api/transport/bookings", {
          ...
          body: JSON.stringify({
            ...
            vehicleRequirements: {
              requiresWheelchairAccessible: fd.get("wheelchair") === "on",
            },
          }),
        });
        setLoading(false);
    ...
    >
      ...
      <p className="text-sm text-muted-foreground">
        {dynamicRoutingEnabled
          ? "After you submit, open the booking to see a straight-line route estimate and optional route plan."
