...
Employment disruptions always require a human coordinator. Substitution and schedule changes are participant-controlled.

See [`wave-11-domain-adapters.md`](./wave-11-domain-adapters.md).

## Rules

- `employment-adapter` emits `other` (employment) signals only.
- No automatic employer notification or contract changes.
