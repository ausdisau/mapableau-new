...
Finance recovery is **explain-and-hand-off only**. No claim submission, funding-route changes, or spending approvals.

See [`wave-11-domain-adapters.md`](./wave-11-domain-adapters.md) and [`wave-11-architecture-and-risk-plan.md`](./wave-11-architecture-and-risk-plan.md).

## Rules

- `finance-recovery` guard refuses financial approval actions.
- Estimated costs in recovery options are **not** available budget.
- Billing and wallet approvals remain in existing Wave 2–10 flows.
