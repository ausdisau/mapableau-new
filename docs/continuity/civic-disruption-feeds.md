# Civic disruption feeds

External civic feeds register under `CivicFeedRegistration`. Feeds default to disabled; signals remain source-attributed and freshness-checked.

See [`wave-11-civic-feed-registry.md`](./wave-11-civic-feed-registry.md).

## Rules

- No auto-activation of civic feeds.
- Stale feed data cannot drive destructive action.
- Recovery plans must quote feed source and freshness at execution.
