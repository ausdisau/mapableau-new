...
## Topic focus: PLAN VERIFIER

This document covers **PLAN VERIFIER** for AURA operators and reviewers. Production enablement requires gates in PRODUCTION_READINESS.md. Do not claim AURA is an ASI, autonomous case management, or generally production-ready while release gates remain open.
