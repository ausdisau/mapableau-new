...
Approved models, version pins, capability tags, and rollout controls.
...
Approved models, version pins, capability tags, and rollout controls. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.
