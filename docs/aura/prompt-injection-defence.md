...
Input sanitisation, tool-output isolation, and untrusted-content handling.
...
Input sanitisation, tool-output isolation, and untrusted-content handling. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-security.md`
