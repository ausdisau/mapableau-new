...
Plain language, screen-reader surfaces, pause/human-escalation affordances.
...
Plain language, screen-reader surfaces, pause/human-escalation affordances. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-accessibility.md`
