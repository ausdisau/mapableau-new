...
Bias monitoring, equitable outcomes, and impact review for participant-facing automation.
...
Bias monitoring, equitable outcomes, and impact review for participant-facing automation. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-ai-impact-assessment.md`
- `docs/aura/wave-10-outcomes.md`
