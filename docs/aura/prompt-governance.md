...
Prompt templates, change control, forbidden self-descriptions, and audit.
...
Prompt templates, change control, forbidden self-descriptions, and audit. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.
