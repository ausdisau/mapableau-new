...
Evaluation suites, regression gates, and release criteria for agent behaviour.
...
Evaluation suites, regression gates, and release criteria for agent behaviour. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.
