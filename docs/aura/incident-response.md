...
AI incident classification, containment, notification, and post-incident review.
...
AI incident classification, containment, notification, and post-incident review. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-ai-incidents.md`
