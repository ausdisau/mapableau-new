...
Declarative manifests: capabilities, tools, authority ceilings, and version pins.
...
Declarative manifests: capabilities, tools, authority ceilings, and version pins. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.
