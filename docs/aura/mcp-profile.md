...
Model Context Protocol adapter profile: transport, auth, and non-trust boundaries.
...
Model Context Protocol adapter profile: transport, auth, and non-trust boundaries. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-mcp.md`
