...
Participant-initiated goals, clarification loops, and refusal when intent is ambiguous or out of scope.
...
Participant-initiated goals, clarification loops, and refusal when intent is ambiguous or out of scope. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-planning.md`
