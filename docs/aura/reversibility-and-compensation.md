...
Undo paths, compensating actions, and participant notification when automation fails.
...
Undo paths, compensating actions, and participant notification when automation fails. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.
