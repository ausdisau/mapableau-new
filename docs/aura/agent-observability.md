...
Traces, structured logs, and dashboards without storing hidden chain of thought.
...
Traces, structured logs, and dashboards without storing hidden chain of thought. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-observability.md`
