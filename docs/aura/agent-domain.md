...
Bounded agent domains, roles, and separation of concerns for the participant Agent OS.
...
Bounded agent domains, roles, and separation of concerns for the participant Agent OS. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-agents.md`
- `docs/aura/wave-10-agent-os.md`
