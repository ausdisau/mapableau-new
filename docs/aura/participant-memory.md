...
Opt-in, participant-controlled memory scopes, retention, and erasure.
...
Opt-in, participant-controlled memory scopes, retention, and erasure. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-memory.md`
