...
Agent-to-agent interoperability profile; external agents require explicit federation policy.
...
Agent-to-agent interoperability profile; external agents require explicit federation policy. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-a2a.md`
