...
Controlled transfers between specialists with context minimisation and consent checks.
...
Controlled transfers between specialists with context minimisation and consent checks. This surface is bounded by authority envelopes, plan validation, simulation, and approval mechanics.

## Related Wave 10 references

- `docs/aura/wave-10-handoffs.md`
