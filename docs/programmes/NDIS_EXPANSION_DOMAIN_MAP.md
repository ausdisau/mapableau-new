...
| ------------------------------ | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| AT Continuity                  | `lib/platform/at-continuity/**` (Wave 1 scaffold in #382; writers flag-gated; not on main yet) | ParticipantProfile, ConsentRecord, AuditEvent, Care/Transport/Jobs links, Organisation / provider refs    | Clinical suitability SoT; second participant identity; emergency-response claims                              |
...
| Plan Management Infrastructure | `lib/support/plan-manager/**` + `lib/billing/**` (extend)                                     | Billing Centre, catalogue, agreements                                                                     | Live NDIA submit; AI payment approval                                                                         |
