...
| Geoscape Predictive / spatial adapters | `lib/geoscape-predictive/**`, `lib/spatial/**`           | Address resolution candidates + provenance   | Server-only; must not write AccessPlace or claim accessibility          |
