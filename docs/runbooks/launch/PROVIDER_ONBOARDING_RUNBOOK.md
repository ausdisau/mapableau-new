# PROVIDER_ONBOARDING_RUNBOOK

## Owner
ops

## Summary
Provider onboarding runbook verified.
...
- Related platform gap `launch.PROVIDER_ONBOARDING_RUNBOOK` shows met when status is ready or waived
