# STATUS_COMMS_CHANNEL

## Owner
ops

## Summary
Status comms channel configured and tested.
...
- Related platform gap `launch.STATUS_COMMS_CHANNEL` shows met when status is ready or waived
