# PEER_MODERATION_READY

## Owner
product

## Summary
Peer moderation policy and tooling ready.
...
- Related platform gap `launch.PEER_MODERATION_READY` shows met when status is ready or waived
