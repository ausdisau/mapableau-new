    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 max-w-2xl text-muted-foreground">
          Request disability-aware transport, track your trip, confirm completion, and report safety
          issues. Pricing shown is a placeholder until NDIS Pricing Intelligence is connected.
        </p>
      </header>
