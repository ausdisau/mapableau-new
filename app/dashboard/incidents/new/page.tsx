...
export default function NewIncidentPage() {
  ...
  return (
    ...
    >
      ...
      <label htmlFor="title" className="text-sm font-medium">What happened (title)</label>
      ...
      <label htmlFor="severity" className="text-sm font-medium">How serious is this?</label>
