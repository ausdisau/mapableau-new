    ...
    <div className="rounded-2xl border border-[#DCE8EB] bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 font-heading text-3xl font-bold text-[#0C1833]">
            {value}
          </p>
...
function DashboardLinkCard({
  ...
  return (
    ...
    >
      ...
      <h2 className="mt-4 font-heading text-lg font-bold text-[#0C1833]">
        {title}
      </h2>
      <p className="mt-1 flex-1 text-sm leading-6 text-[#526574]">
        {description}
      </p>
...
export default async function DashboardPage() {
  ...
  const densityClass =
    presentation.applied && presentation.policy?.informationDensity === "low"
      ? "max-w-5xl space-y-8"
      : "max-w-7xl space-y-8";
        ...
        <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-base leading-7 text-[#E7F7FA]">
              Coordinate access, care, transport, work and support from one
              place. You remain in control of consent, choices and approvals.
            </p>
        ...
        <div className="mb-4 flex items-end justify-between gap-4">
          <div>
            ...
            <h2
              ...
              className="mt-1 font-heading text-2xl font-bold text-[#0C1833]"
            >
      ...
      <section className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-2xl border border-[#DCE8EB] bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-[#F6FBFC] p-4">
              <p className="text-sm font-semibold text-[#526574]">
                Incident reports
              </p>
              <p className="mt-1 font-heading text-2xl font-bold text-[#0C1833]">
                {incidentCount}
              </p>
            </div>
            <div className="rounded-xl bg-[#F6FBFC] p-4">
        ...
        <div className="rounded-2xl border border-[#DCE8EB] bg-[#F6FBFC] p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-[#526574]">
            Review accessibility preferences, consent and profile information
            before sharing it across MapAble services.
          </p>
      ...
      <section aria-labelledby="services-heading">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <DashboardLinkCard
            ...
            badge={
              careBookingsCount
                ? String(careBookingsCount) +
                  " booking" +
                  (careBookingsCount === 1 ? "" : "s")
                : undefined
            }
          />
          <DashboardLinkCard
            ...
            badge={
              transportTripsCount
                ? String(transportTripsCount) +
                  " trip" +
                  (transportTripsCount === 1 ? "" : "s")
                : undefined
            }
          />
          <DashboardLinkCard
          ...
          <DashboardLinkCard
            ...
            badge={
              unreadNotifications
                ? String(unreadNotifications) + " unread"
                : undefined
            }
          />
          <DashboardLinkCard
          ...
          {engagementEnabled ? (
            <DashboardLinkCard
              ...
              badge={
                openEngagementCount
                  ? String(openEngagementCount) + " open"
                  : undefined
              }
            />
          ) : null}
          {caseManagementConfig.enabled ? (
            <DashboardLinkCard
              ...
              badge={
                openCaseCount ? String(openCaseCount) + " open" : undefined
              }
            />
          ) : null}
        </div>
