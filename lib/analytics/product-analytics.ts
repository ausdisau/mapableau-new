/**
 * Lightweight product analytics hook for client-side events.
 * Wire Amplitude/GA via a listener on `mapable-analytics` or replace this module
 * when a first-party SDK is added.
 */
