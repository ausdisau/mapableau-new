...
/** Operations export: G:\\Operations\\MapAble\\MapAble by Australian Disability Ltd.kml */
export const ACCESS_ADL_KML_FILENAME =
  "MapAble by Australian Disability Ltd.kml";

export const MAPABLE_ADL_SOURCE_LABEL =
  "MapAble by Australian Disability Ltd";

/** Compact Access Map dataset generated by scripts/sync-mapable-adl-kml.py */
export const MAPABLE_ADL_DATASET_PUBLIC_PATH =
  "public/data/mapable-adl-places.json";

/** Full My Maps export is ~15MB / ~7k placemarks — allowlisted fetch uses these caps. */
export const MAPABLE_ADL_KML_MAX_BYTES = 20_000_000;
export const MAPABLE_ADL_KML_MAX_ITEMS = 10_000;
