...
export const mapableNavLinkActiveClass = cn(
  "rounded-xl px-3 py-2 text-sm font-black bg-[#005B7F]/10 text-[#005B7F]",
  mapableCareFocusRing,
);
...
export const mapableSearchInputClass = cn(
  "min-h-12 w-full rounded-xl border border-slate-200 bg-white py-3 pr-3 text-base text-[#0C1833] shadow-sm outline-none transition placeholder:text-slate-500 focus-visible:border-[#005B7F]/40 disabled:cursor-not-allowed disabled:opacity-60",
  mapableCareFocusRingSubtle,
);
