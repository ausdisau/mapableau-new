...
export const visionAccessFlags = {
  ...
  /** Permanent prohibitions — must stay false in production policy. */
  faceIdentification: envTrue("MAPABLE_VISION_FACE_IDENTIFICATION_ENABLED"),
  biometricAnalysis: envTrue("MAPABLE_VISION_BIOMETRIC_ANALYSIS_ENABLED"),
  disabilityInference: envTrue("MAPABLE_VISION_DISABILITY_INFERENCE_ENABLED"),
  backgroundRecording: envTrue("MAPABLE_VISION_BACKGROUND_RECORDING_ENABLED"),
  autoPublish: envTrue("MAPABLE_VISION_AUTO_PUBLISH_ENABLED"),
  autoRouteClosure: envTrue("MAPABLE_VISION_AUTO_ROUTE_CLOSURE_ENABLED"),
  autoNavigation: envTrue("MAPABLE_VISION_AUTO_NAVIGATION_ENABLED"),
  physicalActions: envTrue("MAPABLE_VISION_PHYSICAL_ACTIONS_ENABLED"),
} as const;
