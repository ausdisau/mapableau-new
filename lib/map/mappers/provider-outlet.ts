...
export function providerToMapPointEntity(provider: Provider): MapPointEntity | null {
...
export function providersToMapGeoJSON(providers: Provider[]) {
  const entities = providers
    .map(providerToMapPointEntity)
