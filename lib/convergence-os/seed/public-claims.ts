...
export const PUBLIC_CLAIM_REGISTRY: PublicClaimEntry[] = [
  ...
  },
  {
    ...
    surface: "transport",
    capabilityKey: "transport.trip_ops",
    currentMaturity: "scaffold",
    publicClaimAllowed: false,
  ...
  },
  {
    ...
    sourceOnMain: false,
    notes: "Completion must never equal competency.",
  },
  {
  ...
  },
  {
    ...
    sourceOnMain: false,
    notes: "mobile-contracts on main; Expo app not production.",
  },
  {
  ...
  },
  {
    ...
    sourceOnMain: false,
    notes: "No duplicate operational writers.",
  },
  {
