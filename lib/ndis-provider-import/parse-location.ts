...
export function parseOutletAddress(address: string): LocationParsed | null {
...
export function parseHeadOffice(headOffice: string): LocationParsed {
...
export function stableProviderId(normalizedAbn: string): string {
  return `ndis-${normalizedAbn}`;
}
