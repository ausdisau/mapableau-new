...
export const HIGH_RISK_ROUTES: HighRiskRoute[] = [
  ...
  {
    method: "POST",
    path: "/api/participant-vault/items",
    consequence: "pii_write",
    zodRequired: true,
    tenantAssertRequired: false,
    notes: "Participant-owned vault upload/attach; ObjectStore triple gate for bytes",
  },
  {
    method: "POST",
    path: "/api/participant-vault/items/[id]/share",
    consequence: "consent",
    zodRequired: true,
    tenantAssertRequired: false,
    notes: "Owner-only DocumentAccessGrant; purpose + expiry; process-local rate limit",
  },
  {
    method: "POST",
    path: "/api/participant-vault/items/[id]/revoke",
    consequence: "consent",
    zodRequired: true,
    tenantAssertRequired: false,
    notes: "Owner-only grant revoke; idempotent",
  },
  {
    method: "POST",
